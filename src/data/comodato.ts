...
export const etapasComodato = [
  ...
  { titulo: 'Implementação e treinamento', texto: `Entregamos em até ${CONSTANTES_NEGOCIO.entregaDiasUteis} dias úteis, instalamos a Ink Injector e treinamos a equipe.` },
