...
export const faq = [
  ...
  { pergunta: 'Quanto tempo dura uma recarga?', resposta: `Cada recarga tem rendimento calculado de aproximadamente ${CONSTANTES_NEGOCIO.kmPorRecarga} km de escrita, garantindo economia real e previsibilidade no consumo.` },
